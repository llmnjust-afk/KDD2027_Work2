...
\Cref{tab:baselines} reports the expected baseline performance for each model and suite, providing reference points for future work. DeepSeek-V3 is the strongest on synthetic (88.4\%) and UCI (94.2\%) tasks. DSBench is challenging for all evaluated models (0--3.3\%).
